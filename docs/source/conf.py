...
release = '<PARAM: api_version.major_version.revision_number>'
...
htmlhelp_basename = 'PARAMProjectNamedoc'
...
man_pages = [
    (master_doc, 'paramprojectname', '<PARAM: Project Name> Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PARAMProjectName', '<PARAM: Project Name> Documentation',
     author, 'PARAMProjectName', 'One line description of project.',
     'Miscellaneous'),
]
